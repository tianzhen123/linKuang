...
(function(window, undefined){
	...
	TouchSlider.prototype={
		...
		resize:function(){
			...
			this.css(this.container,{/*'overflow':'hidden',*/'visibility':'hidden','listStyle':'none','position':'relative',/*'overflow-y': 'auto','overflow-x': 'hidden',*/});
