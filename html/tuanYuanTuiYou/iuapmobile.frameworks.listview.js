		...
		ListView.prototype.init = function(options) {
			...
			self._touchMethods = {
				...
				fnTouchmove : function(e, self) {
					...
					// 加载上方
					if (self.config.pullDownEnable && self.opts.pullDistance>33 && self._pullDirection == 'down') {
						//e.preventDefault();
					...
					// 加载下方
					if (self.config.pullUpEnable && self.opts.pullDistance>33 && self._pullDirection == 'up') {
						//e.preventDefault();
