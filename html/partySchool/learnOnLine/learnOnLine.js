...
summerready = function(){
		viewModel ={
			...
			openWin:function(data){
				...
				summer.openWin({
				"id" : "learnOnLineDet",
				"url" : "html/partySchool/learnOnLine/learnOnLineDet.html",
				"isKeep" : true,
				"pageParam" : {
					"count" : data,
				}
...
function netService(pageIndex,title){
	var url = ""+getHttpPro()+"zxstudy/list?title="+title+"&pageIndex="+pageIndex+"&pageSize=10&sortField=ts&sortDirection=desc";
	summer.get(url, {}, {
