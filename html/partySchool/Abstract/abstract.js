...
summerready = function(){
		viewModel ={
			...
			openWin:function(data){
				...
				summer.openWin({
				"id" : "abstractDetail",
				"url" : "html/partySchool/Abstract/abstractDetail.html",
				"isKeep" : true,
				"pageParam" : {
					"count" : data,
				}
...
function netService(pageIndex,title){
	var url = ""+getHttpPro()+"ylbasic/list?title="+title+"&pageIndex="+pageIndex+"&pageSize=10&sortField=ts&sortDirection=desc";
	summer.get(url, {}, {
